...
#            onsetTH=int(cuadroOnset.get())
#            offsetTH=int(cuadroOffset.get())
#            maxvalue=int(cuadroMax.get())
#            minvalue=int(cuadroMin.get())
            onsetTH=float(cuadroOnset.get())
            offsetTH=float(cuadroOffset.get())
            maxvalue=float(cuadroMax.get())
            minvalue=float(cuadroMin.get())
