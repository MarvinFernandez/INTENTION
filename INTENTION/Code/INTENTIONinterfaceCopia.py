...
#         lKnee, lAnkle] 
    ...
    Canal1_Env_Total = emg[4]
    Canal2_Env_Total = emg[5]
    Canal3_Env_Total = emg[6]
    Canal4_Env_Total = emg[7]
...
#    rawData = [Canal1_Total, Canal2_Total, Onset, 0]
    ...
    Canal1_Env_Total = emg2[4]
    Canal2_Env_Total = emg2[5]
    Canal3_Env_Total = emg2[6]
    Canal4_Env_Total = emg2[7]
...
#        Canal4_Env_Total = Data[15]
        ...
        Canal1_Env_Total = Data[4]
        Canal2_Env_Total = Data[5]
        Canal3_Env_Total = Data[6]
        Canal4_Env_Total = Data[7]
...
#            
            ...
            emgpl = [Canal1_Raw_Total, Canal2_Raw_Total, Canal3_Raw_Total, Canal4_Raw_Total, 
                     Canal1_Env_Total, Canal2_Env_Total, Canal3_Env_Total, Canal4_Env_Total]
#            emgpl = [Canal1_Raw_Total, Canal2_Raw_Total, Canal1_Env_Total, Canal2_Env_Total]
            plot_button=Button(master=window, command = muscles4Plot(emgpl,window))
#            window=Tk()
...
#    df = pd.concat([dft,df0,df1,df2,df3,df4,df5,df6,df7,df8,df9,df10,df11], axis = 1)
    df = pd.concat([dft,df2,df3,df8,df9], axis = 1)
